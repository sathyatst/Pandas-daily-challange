...
try:
    ...
    IGNORED_COLORS = [s for s in (args.ignored_colors or "").split(",")]
    CELLS_TO_BE_ADDED = [s for s in (args.add_ranges or "").split(",")]
    IGNORED_RANGES = [s for s in (args.ignore_ranges or "").split(",")]
except Exception:
    pass
